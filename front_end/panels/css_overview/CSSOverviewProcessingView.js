...
export class CSSOverviewProcessingView extends UI.Widget.Widget {
    ...
    render() {
        const cancelButton = UI.UIUtils.createTextButton(i18nString(UIStrings.cancel), () => this.controller.dispatchEventToListeners(Events.RequestOverviewCancel), '', true /* primary */);
