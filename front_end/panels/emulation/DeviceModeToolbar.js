...
export class DeviceModeToolbar {
    ...
    modeMenuClicked(event) {
        ...
        const contextMenu = new UI.ContextMenu.ContextMenu(event.data, false, this.modeButton.element.totalOffsetLeft(), this.modeButton.element.totalOffsetTop() + this.modeButton.element.offsetHeight);
