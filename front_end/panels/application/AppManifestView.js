...
export class AppManifestView extends UI.Widget.VBox {
    ...
    async updateManifest(immediately) {
        ...
        this.throttler.schedule(() => this.renderManifest(url, data, errors, installabilityErrors, manifestIcons), immediately);
    }
    async renderManifest(url, data, errors, installabilityErrors, manifestIcons) {
