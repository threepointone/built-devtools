...
export declare class DeviceModeModel extends Common.ObjectWrapper.ObjectWrapper<EventTypes> implements SDK.TargetManager.SDKModelObserver<SDK.EmulationModel.EmulationModel> {
    private screenRectInternal;
    private visiblePageRectInternal;
    private availableSize;
    private preferredSize;
    private initialized;
    private appliedDeviceSizeInternal;
    private appliedDeviceScaleFactorInternal;
    private appliedUserAgentTypeInternal;
    private readonly experimentDualScreenSupport;
    private readonly webPlatformExperimentalFeaturesEnabledInternal;
    private readonly scaleSettingInternal;
    private scaleInternal;
    private widthSetting;
    private heightSetting;
    private uaSettingInternal;
    private readonly deviceScaleFactorSettingInternal;
    private readonly deviceOutlineSettingInternal;
    private readonly toolbarControlsEnabledSettingInternal;
    private typeInternal;
    private deviceInternal;
    private modeInternal;
    private fitScaleInternal;
    private touchEnabled;
    private touchMobile;
    private emulationModel;
    private onModelAvailable;
    private emulatedPageSize?;
    private outlineRectInternal?;
    private constructor();
